      ...
      <main className="max-w-4xl mx-auto py-10 px-4">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="relative w-full md:w-1/2 aspect-square bg-muted rounded-lg overflow-hidden">
            {false ? (
              <Image src="" alt="Pinceles Nikamavi" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            ) : (
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            {true && (
              <p className="text-base text-primary font-semibold mb-1">Entrada sector Nikamavi</p>
            )}
            <h1 className="font-serif font-bold text-2xl md:text-3xl text-foreground leading-tight">Pinceles Nikamavi</h1>
            {true && (
              <p className="text-base text-muted-foreground leading-relaxed">Entrada al sector Pinceles Nikamavi.</p>
            )}
            {/* Features */}
            {true && (
              <ul className="mt-2 mb-2 list-disc pl-5 text-sm text-foreground"><li className="mb-1">Acceso al sector Pinceles Nikamavi</li></ul>
            )}
            {/* CTA Link */}
            {false && (
            ...
            {/* Agregar al carrito */}
            <div className="mt-4">
              <AddToCartSection product={{"id":"b2606f95-fc06-4a46-9e98-8870fcb2b8c9","slug":"pinceles-nikamavi","name":"Pinceles Nikamavi","description":"Entrada al sector Pinceles Nikamavi.","subtitle":"Entrada sector Nikamavi","price_ars":8000,"price_usd":null,"stock":50,"max_per_order":10,"image_url":null,"is_active":true,"is_featured":false,"product_type":"ticket","badge":null,"features":["Acceso al sector Pinceles Nikamavi"],"cta_link":null,"categories":{"name":"Tickets de Entrada"}}} />
            </div>
