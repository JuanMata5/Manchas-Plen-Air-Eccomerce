      ...
      <main className="max-w-4xl mx-auto py-10 px-4">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="relative w-full md:w-1/2 aspect-square bg-muted rounded-lg overflow-hidden">
            {false ? (
              <Image src="" alt="Vivi Di Donato · Arte Acuarela" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            ) : (
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <h1 className="font-serif font-bold text-2xl md:text-3xl text-foreground leading-tight">Vivi Di Donato · Arte Acuarela</h1>
            {true && (
              <p className="text-base text-muted-foreground leading-relaxed">Te invito a visitar mi mesa; participás del sorteo al cierre del workshop.</p>
            )}
            {/* Features */}
            {true && (
              <ul className="mt-2 mb-2 list-disc pl-5 text-sm text-foreground"><li className="mb-1">Visita al stand</li><li className="mb-1">Sorteo al cierre del workshop</li></ul>
            )}
            {/* CTA Link */}
            {false && (
            ...
            {/* Agregar al carrito */}
            <div className="mt-4">
              <AddToCartSection product={{"id":"34282dbf-8063-4721-ba94-ad42e4af3e36","slug":"vivi-di-donato-arte-acuarela","name":"Vivi Di Donato · Arte Acuarela","description":"Te invito a visitar mi mesa; participás del sorteo al cierre del workshop.","subtitle":"Entrada con sorteo","price_ars":8000,"price_usd":null,"stock":12,"max_per_order":10,"image_url":null,"is_active":true,"is_featured":false,"product_type":"ticket","badge":"Últimas 12 entradas","features":["Visita al stand","Sorteo al cierre del workshop"],"cta_link":null,"categories":{"name":"Tickets de Entrada"}}} />
            </div>
