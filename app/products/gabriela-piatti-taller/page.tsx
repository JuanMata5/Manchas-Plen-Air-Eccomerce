      ...
      <main className="max-w-4xl mx-auto py-10 px-4">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="relative w-full md:w-1/2 aspect-square bg-muted rounded-lg overflow-hidden">
            {false ? (
              <Image src="" alt="Gabriela Piatti · Taller" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            ) : (
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <h1 className="font-serif font-bold text-2xl md:text-3xl text-foreground leading-tight">Gabriela Piatti · Taller</h1>
            {true && (
              <p className="text-base text-muted-foreground leading-relaxed">Comprando mi entrada participás de un sorteo por una obra de pequeño formato.</p>
            )}
            {/* Features */}
            {true && (
              <ul className="mt-2 mb-2 list-disc pl-5 text-sm text-foreground"><li className="mb-1">Sorteo por una obra de pequeño formato</li></ul>
            )}
            {/* CTA Link */}
            {false && (
            ...
            {/* Agregar al carrito */}
            <div className="mt-4">
              <AddToCartSection product={{"id":"3559cf05-18b4-4e2a-9a69-f3793ab4e5d2","slug":"gabriela-piatti-taller","name":"Gabriela Piatti · Taller","description":"Comprando mi entrada participás de un sorteo por una obra de pequeño formato.","subtitle":"Entrada con sorteo","price_ars":8000,"price_usd":null,"stock":50,"max_per_order":10,"image_url":null,"is_active":true,"is_featured":false,"product_type":"ticket","badge":null,"features":["Sorteo por una obra de pequeño formato"],"cta_link":null,"categories":{"name":"Tickets de Entrada"}}} />
            </div>
