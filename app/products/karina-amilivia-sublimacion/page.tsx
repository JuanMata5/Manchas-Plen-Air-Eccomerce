      ...
      <main className="max-w-4xl mx-auto py-10 px-4">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="relative w-full md:w-1/2 aspect-square bg-muted rounded-lg overflow-hidden">
            {false ? (
              <Image src="" alt="Karina Amilivia · Sublimación" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            ) : (
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <h1 className="font-serif font-bold text-2xl md:text-3xl text-foreground leading-tight">Karina Amilivia · Sublimación</h1>
            {true && (
              <p className="text-base text-muted-foreground leading-relaxed">Con la compra de mi entrada obtenés 10% de descuento en mi stand.</p>
            )}
            {/* Features */}
            {true && (
              <ul className="mt-2 mb-2 list-disc pl-5 text-sm text-foreground"><li className="mb-1">10% de descuento en el stand</li></ul>
            )}
            {/* CTA Link */}
            {false && (
            ...
            {/* Agregar al carrito */}
            <div className="mt-4">
              <AddToCartSection product={{"id":"e9bd4e8c-6106-41dd-9a12-1fbb43bf3bc9","slug":"karina-amilivia-sublimacion","name":"Karina Amilivia · Sublimación","description":"Con la compra de mi entrada obtenés 10% de descuento en mi stand.","subtitle":"Entrada con 10% OFF","price_ars":8000,"price_usd":null,"stock":50,"max_per_order":10,"image_url":null,"is_active":true,"is_featured":false,"product_type":"ticket","badge":null,"features":["10% de descuento en el stand"],"cta_link":null,"categories":{"name":"Tickets de Entrada"}}} />
            </div>
