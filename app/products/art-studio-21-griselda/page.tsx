      ...
      <main className="max-w-4xl mx-auto py-10 px-4">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="relative w-full md:w-1/2 aspect-square bg-muted rounded-lg overflow-hidden">
            {false ? (
              <Image src="" alt="Art Studio 21 · Griselda" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            ) : (
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            <h1 className="font-serif font-bold text-2xl md:text-3xl text-foreground leading-tight">Art Studio 21 · Griselda</h1>
            {true && (
              <p className="text-base text-muted-foreground leading-relaxed">Comprando mi entrada participás del sorteo al cierre de mi workshop.</p>
            )}
            {/* Features */}
            {true && (
            ...
            {/* Agregar al carrito */}
            <div className="mt-4">
              <AddToCartSection product={{"id":"184895fd-11d1-40b7-9dfe-4c7f2d61d7fd","slug":"art-studio-21-griselda","name":"Art Studio 21 · Griselda","description":"Comprando mi entrada participás del sorteo al cierre de mi workshop.","subtitle":"Entrada con sorteo","price_ars":8000,"price_usd":null,"stock":50,"max_per_order":10,"image_url":null,"is_active":true,"is_featured":false,"product_type":"ticket","badge":null,"features":["Sorteo al cierre del workshop"],"cta_link":null,"categories":{"name":"Tickets de Entrada"}}} />
            </div>
