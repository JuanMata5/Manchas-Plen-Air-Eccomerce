      ...
      <main className="max-w-4xl mx-auto py-10 px-4">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="relative w-full md:w-1/2 aspect-square bg-muted rounded-lg overflow-hidden">
            {false ? (
              <Image src="" alt="Workshop Carolina Curti" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            ) : (
          ...
          <div className="flex-1 flex flex-col gap-4">
            ...
            {true && (
              <p className="text-base text-primary font-semibold mb-1">Entrada con sorteo al cierre</p>
            )}
            <h1 className="font-serif font-bold text-2xl md:text-3xl text-foreground leading-tight">Workshop Carolina Curti</h1>
            {true && (
              <p className="text-base text-muted-foreground leading-relaxed">Con la compra de mi entrada participás de un sorteo al cierre de mi workshop.</p>
            )}
            {/* Features */}
            {true && (
              <ul className="mt-2 mb-2 list-disc pl-5 text-sm text-foreground"><li className="mb-1">Participás de un sorteo al cierre del workshop</li></ul>
            )}
            {/* CTA Link */}
            {false && (
            ...
            {/* Agregar al carrito */}
            <div className="mt-4">
              <AddToCartSection product={{"id":"a0176906-cdeb-44e1-9302-f8922aa1c614","slug":"workshop-carolina-curti","name":"Workshop Carolina Curti","description":"Con la compra de mi entrada participás de un sorteo al cierre de mi workshop.","subtitle":"Entrada con sorteo al cierre","price_ars":8000,"price_usd":null,"stock":50,"max_per_order":10,"image_url":null,"is_active":true,"is_featured":false,"product_type":"ticket","badge":null,"features":["Participás de un sorteo al cierre del workshop"],"cta_link":null,"categories":{"name":"Tickets de Entrada"}}} />
            </div>
